                ...
                const int &spread[])
{
   ...
   for (int k = 1; k < barsAvail; k++)
   {
      ...
      if (stateCur != prevState)
      {
         if (stateCur == 1)
         {
            bool buyConfirmedNow = (atrOK && hourOK && waitOK);
            if (buyConfirmedNow)
            {
         ...
         {
            bool sellConfirmedNow = (atrOK && hourOK && waitOK);
            if (sellConfirmedNow)
            {
   ...
   {
      Print("EMACrossClone: [CHAN DOAN v1.07] Tong ket tinh lai toan bo lich su da tai (", barsAvail, " nen) -- ",
